  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to The Round - Your online jobs platform. Create, upload, and filter job roles with ease, powered by advanced search technology. Your recruitment journey starts here."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to The Round - Your online jobs platform. Create, upload, and filter job roles with ease, powered by advanced search technology. Your recruitment journey starts here.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1557804506-669a67965ba0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxqb2JzJTJDY29tcGFuaWVzfGVufDB8fHx8MTY4OTA2NjY5M3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
